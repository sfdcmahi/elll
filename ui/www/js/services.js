angular.module('projectElll.services', [])
        ...
        .factory('sosfactory', [function () {
                var sos = {};
                return {
                    setSosId: function(id){
                        sos.id = id;
                    },
                    getSosId: function(){
                        return sos.id;
                    },
                    setVictimPosition: function(pos){
                        sos.victimPosition = pos;
                    },
                    
                    getVictimPosition: function(){
                        return sos.victimPosition;
                    }
                }
            }])
        .factory('appstore', ['$q', function ($q) {
                var Metadata = {};
                Metadata['locationfrequency'] = 60000;
        ...
        .factory('RESTServices', function ($q, $http) {
            ...
            var GCM = function (data) {
                var obj = {};
                obj.method = 'POST';
                obj.data = data;
                obj.path = '/elll/rest/v1/gcm';
